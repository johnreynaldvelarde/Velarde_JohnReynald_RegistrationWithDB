...
namespace Club_Registration {
    ...
    public partial class ClubDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ClubMembersDataTable : global::System.Data.TypedTableBase<ClubMembersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClubMembersRow AddClubMembersRow(long StudentId, string FirstName, string MiddleName, string LastName, int Age, string Gender, string Program) {
...
namespace Club_Registration.ClubDBDataSetTableAdapters {
    ...
    public partial class ClubMembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ClubMembers] ([StudentId], [FirstName], [MiddleName], [LastName], [Age], [Gender], [Program]) VALUES (@StudentId, @FirstName, @MiddleName, @LastName, @Age, @Gender, @Program);
SELECT ID, StudentId, FirstName, MiddleName, LastName, Age, Gender, Program FROM ClubMembers WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ClubMembers] SET [StudentId] = @StudentId, [FirstName] = @FirstName, [MiddleName] = @MiddleName, [LastName] = @LastName, [Age] = @Age, [Gender] = @Gender, [Program] = @Program WHERE (([ID] = @Original_ID) AND ((@IsNull_StudentId = 1 AND [StudentId] IS NULL) OR ([StudentId] = @Original_StudentId)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_MiddleName = 1 AND [MiddleName] IS NULL) OR ([MiddleName] = @Original_MiddleName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Program = 1 AND [Program] IS NULL) OR ([Program] = @Original_Program)));
SELECT ID, StudentId, FirstName, MiddleName, LastName, Age, Gender, Program FROM ClubMembers WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Club_Registration.Properties.Settings.Default.ClubDBConnectionString;
        }
        ...
        public virtual int Insert(global::System.Nullable<long> StudentId, string FirstName, string MiddleName, string LastName, global::System.Nullable<int> Age, string Gender, string Program) {
        ...
        public virtual int Update(
            ...
            if ((Original_Program == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_Program));
            }
        ...
        public virtual int Update(global::System.Nullable<long> StudentId, string FirstName, string MiddleName, string LastName, global::System.Nullable<int> Age, string Gender, string Program, int Original_ID, global::System.Nullable<long> Original_StudentId, string Original_FirstName, string Original_MiddleName, string Original_LastName, global::System.Nullable<int> Original_Age, string Original_Gender, string Original_Program) {
            return this.Update(StudentId, FirstName, MiddleName, LastName, Age, Gender, Program, Original_ID, Original_StudentId, Original_FirstName, Original_MiddleName, Original_LastName, Original_Age, Original_Gender, Original_Program, Original_ID);
        }
    }
